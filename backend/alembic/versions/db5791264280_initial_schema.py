...
FK_TEACHERS_TEACHER_ID = 'teachers.teacher_id'
FK_STUDENTS_STUDENT_ID = 'students.student_id'
FK_COURSES_COURSE_ID = 'courses.course_id'
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['teacher_id'], [FK_TEACHERS_TEACHER_ID], ),
    ...
    sa.ForeignKeyConstraint(['student_id'], [FK_STUDENTS_STUDENT_ID], ondelete='CASCADE'),
    ...
    sa.ForeignKeyConstraint(['course_id'], [FK_COURSES_COURSE_ID], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['marked_by'], [FK_TEACHERS_TEACHER_ID], ),
    sa.ForeignKeyConstraint(['student_id'], [FK_STUDENTS_STUDENT_ID], ondelete='CASCADE'),
